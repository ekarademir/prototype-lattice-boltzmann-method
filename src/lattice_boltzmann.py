...
def main():
    ...
    nsx = []
    nsx.append(np.ndarray((LATTICE_SIZE, LATTICE_SIZE)))
    nsx.append(np.ndarray((LATTICE_SIZE, LATTICE_SIZE)))
    nsx.append(np.ndarray((LATTICE_SIZE, LATTICE_SIZE)))
    nsx.append(np.ndarray((LATTICE_SIZE, LATTICE_SIZE)))
    nsx.append(np.ndarray((LATTICE_SIZE, LATTICE_SIZE)))
    ...
    nsx.append(np.ndarray((LATTICE_SIZE, LATTICE_SIZE)))
    nsy = []
    nsy.append(np.ndarray((LATTICE_SIZE, LATTICE_SIZE)))
    nsy.append(np.ndarray((LATTICE_SIZE, LATTICE_SIZE)))
    nsy.append(np.ndarray((LATTICE_SIZE, LATTICE_SIZE)))
    nsy.append(np.ndarray((LATTICE_SIZE, LATTICE_SIZE)))
    nsy.append(np.ndarray((LATTICE_SIZE, LATTICE_SIZE)))
    ...
    nsy.append(np.ndarray((LATTICE_SIZE, LATTICE_SIZE)))
    neqx = []
    neqx.append(np.ndarray((LATTICE_SIZE, LATTICE_SIZE)))
    neqx.append(np.ndarray((LATTICE_SIZE, LATTICE_SIZE)))
    neqx.append(np.ndarray((LATTICE_SIZE, LATTICE_SIZE)))
    neqx.append(np.ndarray((LATTICE_SIZE, LATTICE_SIZE)))
    neqx.append(np.ndarray((LATTICE_SIZE, LATTICE_SIZE)))
    ...
    neqx.append(np.ndarray((LATTICE_SIZE, LATTICE_SIZE)))
    neqy = []
    neqy.append(np.ndarray((LATTICE_SIZE, LATTICE_SIZE)))
    neqy.append(np.ndarray((LATTICE_SIZE, LATTICE_SIZE)))
    neqy.append(np.ndarray((LATTICE_SIZE, LATTICE_SIZE)))
    neqy.append(np.ndarray((LATTICE_SIZE, LATTICE_SIZE)))
    neqy.append(np.ndarray((LATTICE_SIZE, LATTICE_SIZE)))
